  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6">
        ...
        <h1 className="text-lg sm:text-xl font-extrabold mb-2">{report.reason}</h1>
        ...
        <div className="space-y-3 border-t border-gray-200 pt-4">
          <input value={actionTaken} onChange={e => setActionTaken(e.target.value)} placeholder="Action taken" className="w-full px-3 py-3 rounded-lg border border-gray-300 text-sm min-h-[44px]" />
          <textarea value={notes} onChange={e => setNotes(e.target.value)} placeholder="Resolution notes..." className="w-full px-3 py-3 rounded-lg border border-gray-300 text-sm min-h-[80px]" rows={3} />
          <div className="flex flex-col sm:flex-row gap-3">
            <button onClick={() => resolve('resolved')} className="bg-green-500 text-white px-4 py-3 rounded-lg font-bold text-sm min-h-[44px]">Resolve</button>
            <button onClick={() => resolve('dismissed')} className="bg-gray-400 text-white px-4 py-3 rounded-lg font-bold text-sm min-h-[44px]">Dismiss</button>
            <button onClick={() => resolve('reviewed')} className="bg-blue-500 text-white px-4 py-3 rounded-lg font-bold text-sm min-h-[44px]">Mark Reviewed</button>
          </div>
        </div>
      </div>
    </div>
